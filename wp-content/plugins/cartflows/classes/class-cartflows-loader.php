...
if ( ! class_exists( 'Cartflows_Loader' ) ) {
	...
	final class Cartflows_Loader {
		...
		public function define_constants() {
			...
			define( 'CARTFLOWS_VER', '1.6.15' );
			define( 'CARTFLOWS_SLUG', 'cartflows' );
			define( 'CARTFLOWS_SETTINGS', 'cartflows_settings' );
			define( 'CARTFLOWS_NAME', 'CartFlows' );

			define( 'CARTFLOWS_REQ_CF_PRO_VER', '1.6.13' );
		...
		public function after_cartflows_pro_init() {
			...
			if ( version_compare( CARTFLOWS_PRO_VER, CARTFLOWS_REQ_CF_PRO_VER, '<' ) ) {
				...
				add_filter( 'cartflows_react_admin_localize', array( $this, 'required_cartflows_pro_notice_new_ui' ) );
			}
		}
		 ...
		 */
		public function required_cartflows_pro_notice_new_ui( $localize ) {

			$localize['show_update_pro_notice'] = true;
			$localize['cf_pro_req_ver']         = CARTFLOWS_REQ_CF_PRO_VER;
